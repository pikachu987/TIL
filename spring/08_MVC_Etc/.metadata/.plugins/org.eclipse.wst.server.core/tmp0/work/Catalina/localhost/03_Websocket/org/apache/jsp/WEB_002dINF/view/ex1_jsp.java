 ...
 * Generated at: 2016-09-02 10:22:34 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\tvar wsocket;\n");
      out.write("\t\t\n");
      out.write("\t\tfunction sendMessage(){\n");
      out.write("\t\t\twsocket = new WebSocket(\"ws://localhost:8080/03_Websocket/echo-ws\");\n");
      out.write("\t\t\twsocket.onmessage = onMessage;\n");
      out.write("\t\t\twsocket.onclose = onClose;\n");
      out.write("\t\t\twsocket.onopen = function(){\n");
      out.write("\t\t\t\twsocket.send($('#msg').val());\n");
      out.write("\t\t\t};\n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
