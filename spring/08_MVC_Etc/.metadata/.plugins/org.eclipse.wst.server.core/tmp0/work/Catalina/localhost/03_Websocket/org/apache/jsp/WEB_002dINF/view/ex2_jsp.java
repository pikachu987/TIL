 ...
 * Generated at: 2016-09-01 14:25:32 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\twsocket = new WebSocket(\"ws://localhost:8080/03_Websocket/chat-ws\");\n");
      out.write("\t\t\twsocket.onopen = onOpen;\n");
      ...
      out.write("\t\t\twsocket.send(\"msg:\"+nickname+\":\"+msg)\n");
      out.write("\t\t\t$('#msg').val(\"\");\n");
      out.write("\t\t}\n");
      out.write("\t});\n");
      out.write("</script>\n");
