...
> Main1_xml.java는 only XML 설정방식을 사용했다.
* src/main/resources/config_main1.xml
> Main2_java.java 는 only Java 설정방식을 사용했다.
* com.company.config.Config_main2.java
> Main3_.java 는 XML에서 java코드 설정을 조합한 방식을 사용했다.
* src/main/resources/config_main3.xml
* com.company.config.Config_main3.java
> Main4_.java 는 java코드에서 XML 설정을 조합한 방식을 사용했다.
* com.company.config.Config_main4.java
* src/main/resources/config_main4.xml
